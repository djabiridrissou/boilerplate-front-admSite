                    ...
                    <>
                        <div className="mx-auto w-full py-3 mb-3 px-6 sm:px-6 lg:px-8 shadow-md ml-1 z-50">
                            <div className="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
                                <div className="flex md:absolute md:inset-y-0 md:left-0 lg:static xl:col-span-2"></div>
 ...
 */}
                                    ...
                                    <Menu as="div" className="relative ml-5 flex-shrink-0 z-50">
                                        <div className='flex flex-col items-center'>
                                            ...
                                            <span className='text-[9px]'>{user.fullName}</span>
                                        </div>
                                        <Transition
                                            as={Fragment}
                        ...
                        <Popover.Panel as="nav" className="lg:hidden" aria-label="Global">
                            <div className="mx-auto max-w-3xl space-y-1 px-2 pb-3 pt-2 sm:px-4 z-50">
                                {navigation.map((item) => (
                                    <a
                                        key={item.name}
                                        href={item.href}
